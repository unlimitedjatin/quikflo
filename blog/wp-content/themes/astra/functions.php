...
// Shortcode function to display post grid with category filter
function custom_post_grid_shortcode( $atts ) {
    ...
    // Query posts based on shortcode attributes
    $args = array(
        'post_type' => 'post',
        'posts_per_page' => -1,
        'order' => 'DESC',
    ...
    // Display category filter list
    if ( $categories ) {
        echo '<div class="category-filter-container">';
        echo '<div class="category-label">Category</div>';
        echo '<ul class="category-filter">';
        echo '<li><a href="#" data-category="">All Categories</a></li>';
    ...
    <div class="post-grid">
        <?php while ( $query->have_posts() ) : $query->the_post(); ?>
            <div class="post-item post-<?php echo get_the_ID(); ?>">
				<div class="post-meta">
                ...
                <div class="post-details"> 
                    ...
                    <span class="post-expert"><?php echo get_post_meta( get_the_ID(), 'expert', true ); ?></span>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            categoryFilter.addEventListener('click', function(event) {
                ...
                postItems.forEach(function(item) {
                    if (selectedCategory === '' || item.querySelector('.post-category').innerText.includes(selectedCategory)) {
